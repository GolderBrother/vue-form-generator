  ...
  <div class="right-board">
    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        <!-- 组件属性 -->
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="110px">
          ...
          <el-form-item v-if="activeData.__config__.tag === 'el-select'" label="能否创建条目">
            <el-switch v-model="activeData.allowCreate" />
          </el-form-item>
